...
const createBabyEventInbox = `-- name: CreateBabyEventInbox :execrows
...
type CreateBabyEventInboxParams struct {
	EventID   string
	EventType string
	Ctime     int64
}

func (q *Queries) CreateBabyEventInbox(ctx context.Context, arg CreateBabyEventInboxParams) (int64, error) {
	result, err := q.db.Exec(ctx, createBabyEventInbox, arg.EventID, arg.EventType, arg.Ctime)
	if err != nil {
		return 0, err
	}
...
const markBabyEventInboxProcessed = `-- name: MarkBabyEventInboxProcessed :execrows
...
type MarkBabyEventInboxProcessedParams struct {
	EventID string
	Utime   int64
}

func (q *Queries) MarkBabyEventInboxProcessed(ctx context.Context, arg MarkBabyEventInboxProcessedParams) (int64, error) {
	result, err := q.db.Exec(ctx, markBabyEventInboxProcessed, arg.EventID, arg.Utime)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
